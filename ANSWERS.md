...
### .git/hooks/がGitHubにプッシュできない理由

理由は主に2つあり、そもそも.gitディレクトリが共有対象外であることと、セキュリティ上の問題があることです。特に、2つ目の理由に関しては、コミット時に実行されるフックの性質上、悪意のあるスクリプトが仕込まれると攻撃される危険性があることがわかっています。
